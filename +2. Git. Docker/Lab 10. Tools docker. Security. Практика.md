...
Скачаем image
```sh
root@Ubunty-22:/home/noneraspad# docker pull hadolint/hadolint
...
Установим Dive
```sh
root@Ubunty-22:/home/noneraspad# sudo apt install ./dive_0.9.2_linux_amd64.deb
...
Установим Dockle
```sh
root@Ubunty-22:/home/noneraspad/Lab10# ./dockle incedos_fl:latest
```
Запустим
```sh
...
Пулим Anchore
```sh
root@Ubunty-22:/home/noneraspad# docker pull anchore/grype
Using default tag: latest
...
Запускаем
```sh
root@Ubunty-22:/home/noneraspad# docker run -it --rm anchore/grype mongo
